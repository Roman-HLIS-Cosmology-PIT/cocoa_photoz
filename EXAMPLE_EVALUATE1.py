...
def plot_xi(pm, xi, xi_ref = None, param = None, colorbarlabel = None, marker = None, 
                ...
                bintextsize = 15, figsize = (12, 12), show = 1, thetashow=[3,1000]):
...
# Let's PLOT LSSTY1 MASK, DATAVECTOR AND COVARIANCE MATRIX
...
dv_masked = np.array(ci.get_dv_masked())

cov_masked = np.array(ci.get_cov_masked())


# mask = np.hstack([ξp_mask, ξm_mask, γt_mask, w_mask]) ## see https://github.com/CosmoLike/cocoa_roman_real/blob/3a5fd28ec7f0c60e093990177bf3f70d58649517/data/calculate_mask.py#L112C5-L112C58
...
print("~~~~~~~~~~~~~~~~~~~~~~~~")
print()
print("dv masked: ",type(dv_masked),dv_masked.shape)
print("~~~~~~~~~~~~~~~~~~~~~~~~")
print()
print("cov masked: ",type(cov_masked),cov_masked.shape)
print("~~~~~~~~~~~~~~~~~~~~~~~~")